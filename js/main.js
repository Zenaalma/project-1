    // if ($(".item1").text() ==  $(".item2").text()  &&  $(".item1").text() == $(".item3").text() &&  $(".item1").text() !== "")
    // { 
    //     alert("you win" + $(".item1").text()) 
    // } 

    // else if($(".item1").text() == "X" && $(".item5").text() == "X" && $(".item9").text() == "X")
    // {
    //     alert("you win") 
    // } 

    // else if  ($(".item1").text() == "X" && $(".item4").text() == "X" && $(".item7").text() == "X")
    // {
    //     alert("you win") 
    // }
    // else if  ($(".item2").text() == "X" && $(".item5").text() == "X" && $(".item8").text() == "X")
    // {
    //     alert("you win") 
    // }
    // else if ($(".item3").text() == "X" && $(".item5").text() == "X" && $(".item7").text() == "X")
    // { 
    //     alert("you win") 
    // } 

    // else if($(".item3").text() == "X" && $(".item6").text() == "X" && $(".item9").text() == "X")
    // {
    //     alert("you win") 
    // } 

    // else if  ($(".item4").text() == "X" && $(".item5").text() == "X" && $(".item6").text() == "X")
    // {
    //     alert("you win") 
    // }
    // else if  ($(".item7").text() == "X" && $(".item8").text() == "X" && $(".item9").text() == "X")
    // {
    //     alert("you win") 
    // }
    // }
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $("#name-one").text(name1.toUpperCase() + " :")
            ...
            Swal.fire({
                ...
                if (result.value){
                    ...
                    name2 = result.value
                    console.log("Result: " + result.value);
                    $("#name-two").text(name2.toUpperCase() + " :")
